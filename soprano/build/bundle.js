...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*label*/ ctx[0]);
    			attr_dev(button, "class", "svelte-merb4w");
    			add_location(button, file, 15, 0, 239);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["label", "handleClick"];
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { label: 0, handleClick: 1 });
    ...
    // (62:6) {#each paintNotes[type] as notePos (notePos.top)}
    function create_each_block_2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			img = element("img");
    			if (img.src !== (img_src_value = /*noteImg*/ ctx[2][/*type*/ ctx[10]])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = "image of a " + /*type*/ ctx[10] + " note");
    			set_style(img, "position", "absolute");
    			set_style(img, "top", /*notePos*/ ctx[13].top + "px");
    			set_style(img, "left", /*notePos*/ ctx[13].left + "px");
    			add_location(img, file$1, 62, 8, 1193);
    			this.first = img;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(62:6) {#each paintNotes[type] as notePos (notePos.top)}",
    		ctx
    	});
    ...
    // (61:4) {#each noteTypes as type}
    function create_each_block_1(ctx) {
    	let each_blocks = [];
    	let each_1_lookup = new Map();
    	let each_1_anchor;
    	let current;
    	let each_value_2 = /*paintNotes*/ ctx[0][/*type*/ ctx[10]];
    	const get_key = ctx => /*notePos*/ ctx[13].top;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const each_value_2 = /*paintNotes*/ ctx[0][/*type*/ ctx[10]];
    			group_outros();
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(61:4) {#each noteTypes as type}",
    		ctx
    	});
    ...
    // (72:4) {#each buttons as button}
    function create_each_block(ctx) {
    	let current;

    	function func(...args) {
    		return /*func*/ ctx[5](/*button*/ ctx[7], ...args);
    	}

    	const button = new Button({
    			props: {
    				handleClick: func,
    				label: /*button*/ ctx[7].label
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each buttons as button}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let t4;
    	let current;
    	let each_value_1 = /*noteTypes*/ ctx[1];
    	let each_blocks_1 = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			create_component(button.$$.fragment);
    			attr_dev(h1, "class", "svelte-12wmhm7");
    			add_location(h1, file$1, 57, 2, 1007);
    			if (img.src !== (img_src_value = "img/staff.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "image of staff");
    			add_location(img, file$1, 59, 4, 1050);
    			attr_dev(div0, "class", "staff svelte-12wmhm7");
    			add_location(div0, file$1, 58, 2, 1026);
    			attr_dev(div1, "class", "controls svelte-12wmhm7");
    			add_location(div1, file$1, 70, 2, 1416);
    			attr_dev(main, "class", "svelte-12wmhm7");
    			add_location(main, file$1, 56, 0, 998);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*paintNotes, noteTypes, noteImg*/ 7) {
    				each_value_1 = /*noteTypes*/ ctx[1];
    				let i;
    			...
    			if (dirty & /*paintNotes*/ 1) button_changes.handleClick = /*func_1*/ ctx[6];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	const noteTypes = ["natural", "sharp", "flat"];
    	...
    	const defaults = () => {
    		return { natural: [], sharp: [], flat: [] };
    	};

    	let paintNotes = defaults();

    	const drawNotes = note => {
    		$$invalidate(0, paintNotes = defaults());

    		notes.filter(n => n.note === note).forEach(n => {
    			paintNotes[n.type].push(n.pos);
    		});
    	};

    	const func = button => {
    		drawNotes(button.key);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("paintNotes" in $$props) $$invalidate(0, paintNotes = $$props.paintNotes);
    	};

    	return [paintNotes, noteTypes, noteImg, defaults, drawNotes, func, func_1];
    }
